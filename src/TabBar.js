...
import { Animated, NativeModules, StyleSheet, View, ScrollView, Platform, I18nManager } from 'react-native';
...
export default class TabBar<T: *> extends React.Component<Props<T>, State> {
    ...
    static defaultProps = {
        ...
        getAccessible: ({ route }: Scene<T>) => (typeof route.accessible !== 'undefined' ? route.accessible : true),
    ...
    componentDidUpdate(prevProps: Props<T>) {
        ...
        const pendingIndex =
            typeof this._pendingIndex === 'number' ? this._pendingIndex : this.props.navigationState.index;
    ...
    _handlePosition = () => {
        ...
        const offsetX =
            typeof this._lastOffsetX === 'number' ? this._lastOffsetX : -navigationState.index * layout.width;
                ...
                <View style={styles.scroll}>
                    ...
                    >
                        {routes.map((route, i) => {
                            ...
                            const icon = this.props.renderIcon ? this.props.renderIcon({ route }) : null;
                            const badge = this.props.renderBadge ? this.props.renderBadge({ route }) : null;
